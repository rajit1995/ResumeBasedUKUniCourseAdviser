...
A Gradio web app that:
  ...
  3. Uses the (possibly-edited) analysis report to determine whether the
     ...
     university's UK rank, acceptance rate, international acceptance
     rate, India-friendliness score and competitiveness.
  4. Asks the LLM to act as an admissions-aware advisor: it weighs how
     ...
     competitiveness, acceptance rates, and how welcoming it is reported
     to be towards international / Indian applicants), then returns a
